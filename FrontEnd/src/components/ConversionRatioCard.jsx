...
const ConversionRatioCard = ({ reachCount, conversionPercentage }) => {
  const [progress, setProgress] = useState(0);
  const impressionCount = Math.round(reachCount / (conversionPercentage / 100));
