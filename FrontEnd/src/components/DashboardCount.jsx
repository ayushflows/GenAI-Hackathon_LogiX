...
const metrics = [
  {
    ...
    value: '2.1k',
    label: 'Average Likes',
    gradient: 'from-orange-500 via-orange-400 to-gray-800',
  ...
  },
  {
    ...
    gradient: 'from-red-500 via-red-400 to-gray-800',
  ...
  },
  {
    ...
    gradient: 'from-violet-500 via-violet-400 to-gray-800',
  ...
  },
  {
    ...
    value: '8.5k',
    label: 'Average Views',
    gradient: 'from-green-500 via-green-400 to-gray-800',
          ...
          {metrics.map((metric) => (
            ...
            >
              <div className="text-left">
                ...
                <p className="text-lg font-semibold text-white mt-2">{metric.label}</p>
              </div>
