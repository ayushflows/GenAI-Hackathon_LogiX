...
function DashboardCount({analyzedData}) {
  ...
  const metrics = [
    {
      id: 1,
      value: formatValue(analyzedData.likes),
      label: 'Likes',
    ...
    {
      id: 2,
      value: formatValue(analyzedData.comments),
      label: 'Comments',
    ...
    {
      id: 3,
      value: formatValue(analyzedData.shares),
      label: 'Shares',
    ...
    {
      id: 4,
      value: formatValue(analyzedData.reach),
      label: 'Views',
    ...
    return (
      <div id="dashboard" className="mx-2 lg:mx-6 xl:mx-12 mb-[40px] md:mb-[90px] inter-regular">
        ...
        <p className='text-[#c5c5c5] mt-3'>On an average your each {analyzedData.type} has: </p>
